            ...
            (a.ListBuilderService = function(a, b) {
                        ...
                        return (
                            void 0 !== b.listLocation
                                ? "string" == typeof b.listLocation
                                  ...
                                  : "function" == typeof b.listLocation && (a.data = b.listLocation(c))
                                : (a.data = c),
                            a
                        );
                    }
                ...
                (this.init = function(b) {
                    var c = [],
                        d = {};
                    return (
                        (d.data = a.get("listLocation")(b)), (d.getValue = a.get("getValue")), (d.maxListSize = a.get("list").maxNumberOfElements), c.push(d), c
                    );
                }),
    ...
    EasyAutocomplete = (function(a) {
        return (
            (a.proccess = function(b, c, d) {
                ...
                function f(a, c) {
                    return (
                        b.get("list").match.caseSensitive || ("string" == typeof a && (a = a.toLowerCase()), (c = c.toLowerCase())),
                              ...
                              : "iconLeft" === a.type
                                ...
                                : "links" === a.type
                                  ? ("string" == typeof d.link
                                    ...
                                    c)
                                  : "custom" === a.type ? a.method : b.basic.method;
                    },
                    d = function(a) {
                ...
                function d() {
                    return 0 === t.length
                        ...
                        : o.checkDataUrlProperties()
                          ? o.checkRequiredProperties() ? (e(), void g()) : void p.error("Will not work without mentioned properties.")
                                    ...
                                    .on("loadElements.eac", function(b, c, d) {
                                        ...
                                        for (var h = 0, i = 0, k = c.length; k > i; i += 1) {
                                            ...
                                            if (0 !== l.length) {
                                                void 0 !== c[i].header &&
                                                    c[i].header.length > 0 &&
                                                    f.append("<div class='eac-category' >" + c[i].header + "</div>");
                    ...
                    function b() {
                        t.focusout(function() {
                            ...
                            for (var c = 0, d = v.length; d > c; c += 1)
                                if (((a = o.get("getValue")(v[c])), o.get("list").match.caseSensitive || (a = a.toLowerCase()), a === b))
                                    return (w = c), void j(w);
                        });
                    }
                    function c() {
                                ...
                                function c(a, b) {
                                    return o.get("matchResponseProperty") !== !1
                                        ? "string" == typeof o.get("matchResponseProperty")
                                          ...
                                          : "function" == typeof o.get("matchResponseProperty") ? o.get("matchResponseProperty")(b) === a : !0
                                        : !0;
                                }
