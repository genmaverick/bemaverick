...
class BeMaverick_AWSTranscoder
{
     ...
     */
    public static function createJob( $filename, $pipelineId, $presetId, $config )
    {
    ...
    public static function createHLSJob( $filename, $pipelineId, $config )
    {
        ...
        $hls_presets = array(
            'hlsAudio' => BeMaverick_AWSTranscoder::HLS_64K_AUDIO_PRESET_ID,
            'hls0400k' => BeMaverick_AWSTranscoder::HLS_0400K_PRESET_ID,
            'hls1000k' => BeMaverick_AWSTranscoder::HLS_1000K_PRESET_ID,
            'hls1500k' => BeMaverick_AWSTranscoder::HLS_1500K_PRESET_ID,
            'hls2000k' => BeMaverick_AWSTranscoder::HLS_2000K_PRESET_ID,
        );
        ...
        foreach ( $hls_presets as $prefix => $presetId ) {
            ...
            if( $presetId == BeMaverick_AWSTranscoder::HLS_2000K_PRESET_ID ) {
