                        ...
                        (this.prototype.Emitter = Emitter),
                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                resize: function(a, b, c, d) {
                                    ...
                                    return (
                                        (e.srcX = (a.width - e.srcWidth) / 2), (e.srcY = (a.height - e.srcHeight) / 2), (e.trgWidth = b), (e.trgHeight = c), e
                                    );
                                },
                            ...
                            if (
                                ...
                                this.element.classList.contains("dropzone") &&
                                    ...
                                    this.element.appendChild(
                                        b.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")
                                    ),
                                ...
                                for (var c = [], d = a, e = 0, d = d; ; ) {
                                    ...
                                    null != h.webkitGetAsEntry && (g = h.webkitGetAsEntry())
                                        ? g.isFile
                                          ...
                                          : g.isDirectory ? c.push(b._addFilesFromDirectory(g, g.name)) : c.push(void 0)
                                        : null != h.getAsFile && (null == h.kind || "file" === h.kind) ? c.push(b.addFile(h.getAsFile())) : c.push(void 0);
                                }
                                return c;
                            })();
                        }
                                ...
                                if (a[0].upload.chunked) {
                                    ...
                                    var h = function() {
                                        ...
                                        if (!(d >= e.upload.totalChunkCount)) {
                                            ...
                                            (e.upload.chunks[d] = { file: e, index: d, dataBlock: j, status: b.UPLOADING, progress: 0, retries: 0 }),
                                                c._uploadData(a, [j]);
                                        }
                                    };
                                    if (
                            ...
                            if (a[0].status !== b.CANCELED && 4 === c.readyState) {
                                ...
                                this._updateFilesUploadProgress(a),
                                    200 <= c.status && c.status < 300
                                        ? a[0].upload.chunked ? a[0].upload.finishedChunkUpload(this._getChunk(a[0], c)) : this._finished(a, e, d)
