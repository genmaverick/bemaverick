...
$settings = array(
    ...
    'common' => array(
        ...
        'SYSTEM_ADMIN_EMAIL_ADDRESSES'     => array( "dev-app@bemaverick.com", "bbird@qualityworkscg.com" ),

        // http hosts
        'SYSTEM_WEBSITE_HTTP_HOST'         => "dev.genmaverick.com",
        ...
        'SYSTEM_COOKIE_DOMAIN'             => 'dev.genmaverick.com',
        ...
        // aws configs
        'AWS_S3_VIDEO_INPUT_BUCKET_NAME'     => 'dev-bemaverick-input-videos',
        'AWS_S3_VIDEO_OUTPUT_BUCKET_NAME'    => 'dev-bemaverick-output-videos',
        'AWS_S3_VIDEO_THUMBNAIL_BUCKET_NAME' => 'dev-bemaverick-output-videos-thumbnails',
        'AWS_S3_IMAGE_BUCKET_NAME'           => 'dev-bemaverick-images',
        ...
        'AWS_VIDEO_TRANSCODER_RESPONSE_PRESET_ID'   => '1524519776163-crmnvp',
        'AWS_REGION'                         => 'us-east-1',
        'AWS_ACCESS_KEY_ID'                  => 'AKIAILVXMLMU2X62NCSQ',
        'AWS_ACCESS_KEY_SECRET'              => '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',
        'AWS_VIDEO_CLOUD_FRONT_URI'          => 'https://d2qio21iik1dja.cloudfront.net/',
        ...
        // security configs
        'SYSTEM_CSRF_HOST'                 => "dev.genmaverick.com",
        ...
        // react app configs
        'REACT_APP_URL'                  => 'https://dev-app.genmaverick.com/',
    ...
    'website' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "dev.genmaverick.com",
    ...
    'api' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "dev-api.bemaverick.com",
    ...
    'admin' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "dev-admin.bemaverick.com",
