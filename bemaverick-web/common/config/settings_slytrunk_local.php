...
$settings = array(
    ...
    'common' => array(
        ...
        // http hosts
        'SYSTEM_WEBSITE_HTTP_HOST'         => "$USER-website-bemaverick.local.slytrunk.com",
        ...
        'SYSTEM_COOKIE_DOMAIN'             => 'local.slytrunk.com',
        ...
        'SYSTEM_IMAGE_HOST'                => "$USER-api-bemaverick.local.slytrunk.com",
        'SYSTEM_IMAGE_PROTOCOL'            => 'http',
        ...
        // security configs
        'SYSTEM_CSRF_HOST'                 => "local.slytrunk.com",
        ...
        // react app configs
        'REACT_APP_URL'                  => 'http://docker.for.mac.host.internal:3000/',
    ...
    'website' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "$USER-website-bemaverick.local.slytrunk.com",
        'SYSTEM_HTTP_PROTOCOL'             => "http",
    ...
    'api' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "$USER-api-bemaverick.local.slytrunk.com",
    ...
    'admin' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "$USER-admin-bemaverick.local.slytrunk.com",
