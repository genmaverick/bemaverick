...
$settings = array(
    ...
    'common' => array(
        ...
        'SYSTEM_ERROR_EMAIL_ADDRESS'       => "stage-app@bemaverick.com",
        'SYSTEM_ADMIN_EMAIL_ADDRESSES'     => array( "stage-app@bemaverick.com" ),

        // http hosts
        'SYSTEM_WEBSITE_HTTP_HOST'         => "stage.bemaverick.com",
        ...
        // salts
        'SYSTEM_RESET_PASSWORD_SALT'       => '2NGfsjEmd4caH,NE9pxg2xqB',
        'SYSTEM_VERIFY_ACCOUNT_SALT'       => 'wBcvXDLcnkNDWwr32hvye69P',

        // cookie configs
        'SYSTEM_COOKIE_SALT'               => 'HV8Y3j6KFAov@yUHuRJzAQ7W',
        'SYSTEM_COOKIE_DOMAIN'             => 'stage.bemaverick.com',

        // translations configs
        'SYSTEM_TRANSLATION_FILE'          => BEMAVERICK_COMMON_ROOT_DIR . '/translations/strings.tmx',

        // image configs
        'SYSTEM_IMAGE_SALT'                => '64NnupTkk%7XmtTUq6xQbzWw',
        'SYSTEM_IMAGE_HOST'                => "stage-api.bemaverick.com",
        ...
        'OAUTH_ACCESS_TOKEN_SIGNING_SECRET' => 'kvDL7JJghUhHaGG3DB2;6ZYj',
        ...
        // aws configs
        'AWS_S3_VIDEO_INPUT_BUCKET_NAME'     => 'stage-bemaverick-input-videos',
        'AWS_S3_VIDEO_OUTPUT_BUCKET_NAME'    => 'stage-bemaverick-output-videos',
        'AWS_S3_VIDEO_THUMBNAIL_BUCKET_NAME' => 'stage-bemaverick-output-videos-thumbnails',
        'AWS_S3_IMAGE_BUCKET_NAME'           => 'stage-bemaverick-images',
        'AWS_VIDEO_TRANSCODER_ENABLED'       => true,
        'AWS_VIDEO_TRANSCODER_HLS_ENABLED'   => true,
        'AWS_VIDEO_TRANSCODER_PIPELINE_ID'   => '1520280781046-pkwbhq',
        ...
        'AWS_VIDEO_CLOUD_FRONT_URI'          => 'https://d3s6bb016xzt5p.cloudfront.net/',
        ...
        'TWILIO_SERVICE_SID'      => 'IS29f80c74b324451a8d6af4f4578066c9',
        'TWILIO_APPNAME'          => 'stage_maverick',
        ...
        // security configs
        'SYSTEM_CSRF_HOST'      => "stage.bemaverick.com",
    ...
    'website' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "stage.bemaverick.com",
    ...
    'api' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "stage-api.bemaverick.com",
    ...
    'admin' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "stage-admin.bemaverick.com",
