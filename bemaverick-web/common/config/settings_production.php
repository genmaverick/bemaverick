...
$settings = array(
    ...
    'common' => array(
        ...
        'SYSTEM_ERROR_EMAIL_ADDRESS'       => "dev-app@bemaverick.com",
        'SYSTEM_ADMIN_EMAIL_ADDRESSES'     => array( "dev-app@bemaverick.com" ),

        // http hosts
        'SYSTEM_WEBSITE_HTTP_HOST'         => "genmaverick.com",
        ...
        'SYSTEM_REDIS_HOSTS'               => array( 'www01-usw1c-prd-bemaverick.c.gold-cycling-181104.internal:6379' ),

        // frontend configs
        'SYSTEM_LESS_ENABLED'              => false,

        // salts
        'SYSTEM_RESET_PASSWORD_SALT'       => '2cvE7tvfdPGegufQ4mX4zsyD',
        'SYSTEM_VERIFY_ACCOUNT_SALT'       => '7kPZZCZuPwj9C7ipLUe2YaXo',

        // cookie configs
        'SYSTEM_COOKIE_SALT'               => '6TNALN=ZUWHxeh8ty7xnBDw7',
        'SYSTEM_COOKIE_DOMAIN'             => 'genmaverick.com',

        // translations configs
        'SYSTEM_TRANSLATION_FILE'          => BEMAVERICK_COMMON_ROOT_DIR . '/translations/strings.tmx',

        // image configs
        'SYSTEM_IMAGE_SALT'                => 'L8qtWL.tCtbPA3pTM9Jsu9XG',
        'SYSTEM_IMAGE_HOST'                => "d1kvcf8htvsy8g.cloudfront.net",
        'SYSTEM_IMAGE_PROTOCOL'            => 'https',
        'SYSTEM_IMAGE_COMPRESSION_QUALITY' => 90,
        'SYSTEM_ASSETS_DIR'                => '/home/bemaverick/files/assets',
        ...
        'OAUTH_ACCESS_TOKEN_SIGNING_SECRET' => 'wsNJf89xVn7De7L/LiMXMBXK',

        //deep link for the app
        'APP_DEEPLINK'  => 'https://bemaverick.app.link/k4axogHgQM',
        ...
        'AWS_VIDEO_TRANSCODER_HLS_ENABLED'   => false,
        'AWS_VIDEO_TRANSCODER_PIPELINE_ID'   => '1507237364568-289asi',
        ...
        'AWS_LAMBDA_SERVICE_URL'             => 'https://lambda.genmaverick.com/',
        'AWS_LAMBDA_API_KEY'                 => '0mbh8CXZZyWwYYGXbiDvuXka5HnAELNN',
        'AWS_LAMBDA_NOTIFICATION_URL'        => 'https://lambda.genmaverick.com/notification/notification-attemptToSend',
        'AWS_LAMBDA_DEEP_LINK_PROTOCOL'      => 'maverick',
        'AWS_SNS_TOPIC_MODERATION'           => 'arn:aws:sns:us-east-1:415196061258:prod_moderation',
        'AWS_SNS_TOPIC_CHANGE_CONTENT'       => 'arn:aws:sns:us-east-1:415196061258:prod_change_content',
        'AWS_SNS_TOPIC_EVENTS'               => 'arn:aws:sns:us-east-1:415196061258:bemaverick-events-topic-prod',

        // branch
        'MAVERICK_BRANCH_KEY'                => 'key_live_jmrG1Cs2XhvLfIksWSKnHdppztkvhsAj',

        // segment
        'MAVERICK_SEGMENT_KEY'                => 'ObectEZaNEC9lM9zvqJoRRKVtGpyR2xp',

        // leanplum
        'MAVERICK_LEANPLUM_APP_ID'                => 'app_R29Nd2LrIcAQmnTH5W5BhWC1GkuwkemIk8iersuMRww',
        'MAVERICK_LEANPLUM_CLIENT_KEY'                => 'prod_eFC13iWoyQ7a1kjrZBioaRTNkgOTfpgZmJFsZM41JSM',

        // CleanSpeak configs
        'MODERATION_ENABLED'                    => true,
        'CLEANSPEAK_API_KEY'                    => '4c0f7be7-d2e1-4340-ba53-c1da307ede4b',
        ...
        'CLEANSPEAK_API_URL'                    => 'https://genmaverick-cleanspeak-api.inversoft.io/',
        ...
        'TWILIO_SERVICE_SID'      => 'IS937004d282d946abb543a17fecf55b61',
        'TWILIO_APPNAME'          => 'maverick',
        ...
        // security configs
        'SYSTEM_CSRF_HOST'      => "genmaverick.com",
        ...
        // react app configs
        'REACT_APP_URL'                  => 'https://app.genmaverick.com/',
    ...
    'website' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "bemaverick.com",
    ...
    'api' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "api.bemaverick.com",
    ...
    'admin' => array(
        ...
        'SYSTEM_HTTP_HOST'                 => "admin.bemaverick.com",
