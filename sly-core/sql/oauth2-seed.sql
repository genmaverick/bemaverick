...
CREATE TABLE oauth_user_authorized_clients ( user_id VARCHAR(80) NOT NULL, client_id VARCHAR(80) NOT NULL, scope VARCHAR(2000), CONSTRAINT user_id_client_id_pk PRIMARY KEY (user_id, client_id));
