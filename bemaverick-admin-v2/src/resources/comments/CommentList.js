...
import FlaggedField from "components/FlaggedField";
...
const CommentList = withStyles(styles)(({ classes, ...props }) => (
  <List
    ...
    bulkActions={false}
    filterDefaultValues={{ active:'true,false', flagged:'true,false' }}
  >
    <Responsive
      small={
        <SimpleList
      ...
      medium={
        <Datagrid>
          <ImageField
            ...
            label="Avatar"
          />
          <TextField source="meta.user.username" cellClassName={classes.name} label="Username" />
          ...
          <FlaggedField source="flagged" label="Flagged" />
