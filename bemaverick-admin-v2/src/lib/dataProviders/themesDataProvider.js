...
const { lambdaApiUrl, awsLambdaApiKey } = config;
...
const dataProvider = (type, resource, params) => {
  ...
  switch (type) {
    case GET_LIST: {
      ...
      query.limit = perPage;
      url = `${lambdaApiUrl}/${resource}?${stringify(query)}&populate=0`;
      console.log('URL FOR GET LIST', url);
      break;
    }
    case GET_ONE:
      url = `${lambdaApiUrl}/${resource}/${params.id}?populate=0`;
      break;
    case CREATE:
