	...
	****************************/
	...
	$meta_boxes[] = array (
      ...
      'portfolio_details'  => array(
        'label' => __( 'Challenge Details', 'rwmb' ),
        'icon'  => '', // Dashicon
      ),
				'general' => array(
		...
		'fields' => array(
			...
			array (
				'name'	=>	__('Challenge Details','oshin'),
      ...
      array (
				'name'		=> __('Username','oshin'),
				'id'	=> "{$prefix}portfolio_username",
				'desc'		=> '',
				'type'		=> 'text',
				'std'		=> '',
				'tab'		=> 'portfolio_details'
      ...
      array (
				'name'		=> __('Challenge ID','oshin'),
				'id'	=> "{$prefix}portfolio_challenge_id",
				'desc'		=> '',
				'type'		=> 'text',
				'std'		=> '',
				'tab'		=> 'portfolio_details'
      ...
      array (
				'name'		=> __('Number Comments','oshin'),
				'id'	=> "{$prefix}portfolio_number_comments",
				'desc'		=> '',
				'type'		=> 'text',
				'std'		=> '',
				'tab'		=> 'portfolio_details'
      ...
      array (
				'name'		=> __('Number Responses','oshin'),
				'id'	=> "{$prefix}portfolio_number_responses",
				'desc'		=> '',
				'type'		=> 'text',
				'std'		=> '',
				'tab'		=> 'portfolio_details'
