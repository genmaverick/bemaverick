...
.thumb-title-wrap .portfolio-username {
  margin-left: 6px;
  font-weight: 600;
  text-transform: capitalize;
}

.thumb-title-wrap .portfolio-activity {
  display: flex;
  align-items: center;
  font-size: 13px;
}

.thumb-title-wrap .portfolio-activity .activity-container {
  display: flex;
  align-items: center;
  margin: 0 8px 0 8px;
}

.thumb-title-wrap .portfolio-activity .activity-container .comment-icon {
  width: 16px;
  height: 16px;
  margin-left: 3px;
  background-image: url("https://cdn-uploads.genmaverick.com/wp-content/uploads/2018/08/22215954/comment-icon.png");
  background-repeat: no-repeat;
  background-size: 16px 16px;
}

.thumb-title-wrap .portfolio-activity .activity-container .response-icon {
  width: 16px;
  height: 16px;
  margin-left: 3px;
  background-image: url("https://cdn-uploads.genmaverick.com/wp-content/uploads/2018/08/22215955/response-icon.png");
  background-repeat: no-repeat;
  background-size: 16px 16px;
}
