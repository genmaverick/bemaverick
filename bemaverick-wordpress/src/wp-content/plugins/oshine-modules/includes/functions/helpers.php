...
/* ---------------------------------------------  */
if ( ! function_exists( 'get_be_themes_portfolio_info' ) ) :
	function get_be_themes_portfolio_info( $id, $link = false ) {
    $challengeId = get_post_meta( $id, 'be_themes_portfolio_challenge_id', true );
    $challengeUrl = 'https://genmaverick.com/challenge/' . $challengeId;

    $portfolioInfo = array(
      'username' => get_post_meta( $id, 'be_themes_portfolio_username', true ),
      'challengeUrl' => $challengeUrl,
      'numberComments' => get_post_meta( $id, 'be_themes_portfolio_number_comments', true ),
      'numberResponses' => get_post_meta( $id, 'be_themes_portfolio_number_responses', true ),
    );
