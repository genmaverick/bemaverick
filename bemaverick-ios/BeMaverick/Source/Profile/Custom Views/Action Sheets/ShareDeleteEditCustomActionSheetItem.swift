//
//  ShareDeleteEditCustomActionSheetItem.swift
//  Maverick
//
//  Created by Chris Garvey on 6/19/18.
//  Copyright © 2018 BeMaverick. All rights reserved.
//

class ShareDeleteEditCustomActionSheetItem: UIView, CustomMaverickActionSheetItem {
    ...
    /// The closure that contains the delete functionality.
    ...
    /// The delete button that triggers the delete functionality.
    ...
    required init(challenge: Challenge, services: GlobalServicesContainer, deleteAction: @escaping () -> Void, editAction: @escaping () -> Void) {
        super.init(frame: CGRect(x: 16, y: 58, width: 400, height: 220))
