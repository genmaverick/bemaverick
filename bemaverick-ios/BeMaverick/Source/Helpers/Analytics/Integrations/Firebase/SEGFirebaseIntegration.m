...
- (void)identify:(SEGIdentifyPayload *)payload
{
    ...
    [mappedTraits enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *obj, BOOL *stop){
        NSString *trait = [[key stringByReplacingOccurrencesOfString:@" " withString:@"_"] stringByReplacingOccurrencesOfString:@":" withString:@"_"];
        
        NSString *value = [[obj stringByReplacingOccurrencesOfString:@" " withString:@"_"] stringByReplacingOccurrencesOfString:@":" withString:@"_"];
...
- (NSString *)formatFirebaseEventNames:(NSString *)event
{
    ...
    if (mappedEvent) {
        ...
        return [[event stringByReplacingOccurrencesOfString:@" " withString:@"_"] stringByReplacingOccurrencesOfString:@":" withString:@"_"];
    }
}
...
NSDictionary *formatEventProperties(NSDictionary *dictionary)
{
    ...
    [dictionary enumerateKeysAndObjectsUsingBlock:^(id key, id data, BOOL *stop) {
        ...
        key = [[key stringByReplacingOccurrencesOfString:@" " withString:@"_"] stringByReplacingOccurrencesOfString:@":" withString:@"_"];
