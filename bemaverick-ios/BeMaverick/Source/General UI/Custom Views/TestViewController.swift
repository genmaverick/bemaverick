...
//  Maverick
//
//  Created by Garrett Fritz on 6/27/18.
...
class TestViewController : ViewController {
    ...
    @IBAction func tapArea(_ sender: Any) {
        ...
        if isSmall {
//            recorder.previewLayer.contentsScale
            ...
            recorder.previewView = smallView
            recorder.previewViewFrameChanged()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        startup(withPreviewView: smallView)
        isSmall = true
    }
    deinit {
        log.verbose("💥")
...
//    }
    ...
    func startup(withPreviewView view: UIView) {
...
//        recorder.maxRecordDuration = CMTimeMake(Int64(maxRecordingDuration), 1)
        ...
        recorder.previewView = view
          ...
          recorder.previewLayer.videoGravity = .resizeAspect
        
        // Configure video
        
        recorder.videoConfiguration.enabled = true
        recorder.videoConfiguration.size = CGSize(width: 100, height: 100)
//        video.size = Constants.CameraManagerExportSize
        recorder.videoConfiguration.scalingMode = AVVideoScalingModeResize
        recorder.previewLayer.videoGravity = .resizeAspect
//        video.timeScale = 1
...
extension TestViewController: SCRecorderDelegate {
